    ...
    <>
      <Content>
        <PositionWrap>
          ...
          <Description>
            이름, 성별, 생년월일, 주소, 연락처(이메일, 휴대전화, 비상연락망 등)는 주민등록에 기재된 것을 기준으로 작성합니다. <br />
            연락처는 명확히 기재하고, 본인의 연락처 외에비상연락망을 기재하여 연락을 못 받는 경우를 대비하는 것이 좋습니다.
          </Description>

          <Title>학력사항 작성하기</Title>
          <Description>
            학력사항은 최종학력부터 기재해야 합니다.
            <br />
            일반적으로 고교졸업 이상(대학원 포함) 학력을 기술하는데 대학명과 전공명, 재학기간(년/월 단위), 졸업여부(졸업/졸업예정/중퇴/수료) 등을 정확히 써야
            합니다.
          </Description>
          <Table>
            <tr>
          ...
          <Description>
            자신이 근무한 회사명과 주요사업, 소속 부서, 최종 직급, 근무기간, 주요업무 및 성과 등을 표기합니다. <br />
            근무 기간은 연도와 월을 기재하며 만약 부서 이동이나 직책 승진, 해외 근무 등이 있었다면 별도로 표기합니다. <br />
            업무 내용 작성 시 지원하는 직무와 관련된 주요업무와 자신이 만들어낸 성과를 수치화하여 작성합니다.
          </Description>
          <Table>
            <tr>
          ...
          <Description>
            자격사항에는 직무와 관련 있는 자격증을 최근 취득한 순서로 자격명, 취득일, 발행기관을 정확하게 기재해야 합니다.
            <br />
            어학능력은 어학별 점수나 등급과 유효기간을 확인할 수 있도록 취득일을 명확히 기재합니다.
          </Description>
          <Table>
            <tr>
